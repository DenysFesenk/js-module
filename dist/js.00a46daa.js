...
exports.basicsHW = void 0;

function _readOnlyError(name) { throw new Error("\"" + name + "\" is read-only"); }

var basicsHW = function basicsHW() {
...
exports.typesHW = void 0;

var typesHW = function typesHW() {
...
exports.cyclesWH = void 0;

var cyclesWH = function cyclesWH() {
...
exports.funcHW = void 0;

var funcHW = function funcHW() {
  ...
  var foreSeven = document.getElementById('foreSeven').addEventListener('click', function () {
    function time() {
      ...
      var object = [hours, minuts, seconds];
      return alert("".concat(object.hours, ":").concat(object.minuts, ":").concat(object.seconds));
    }
  ...
  var foreEight = document.getElementById('foreEight').addEventListener('click', function () {
    ...
    alert("".concat(getSeconds(), " seconds"));
  ...
  var foreNine = document.getElementById('foreNine').addEventListener('click', function () {
    var number = Number(prompt('Сколько секунд ?', 123456));

    function getSecToHours() {
      var hours = Math.floor(number / 60 / 60);
      var minuts = Math.floor(number / 60) - hours * 60;
      var seconds = number % 60;
      return alert("".concat(hours, ":").concat(minuts, ":").concat(seconds));
    }
...
var obj = function obj() {
  var fiveOne = document.getElementById('fiveOne').addEventListener('click', function () {
    var distance = prompt('Сколько вам нужно проехать км?', 340);
    var car = {
      madeIn: "Germany",
      model: "bmw",
      year: 2020,
    ...
    function getTime() {
      ...
      var allTime = Math.floor(travelTime / 4 + travelTime);
      return alert("".concat(allTime, " hours"));
    }
  ...
  var fiveTwo = document.getElementById('fiveTwo').addEventListener('click', function () {
    var numerator = Number(prompt('Введите первое число!', 20));
    var denominator = Number(prompt('Введите второе число!', 5));
    var object = {
      numerator: numerator,
...
exports.arraysHW = void 0;

var arraysHW = function arraysHW() {// 6.1. Создать массив «Список покупок». Каждый элемент массива является объектом, который содержит название продукта, необходимое количество и куплен или нет. Написать несколько функций для работы с таким массивом.
...
exports.classesHomeWork = void 0;

var classesHomeWork = function classesHomeWork() {// 7.1 Реализовать класс, описывающий окружность. В классе должны быть следующие компоненты:
...
exports.classesHomeWork = classesHomeWork;
...
(0, _objects.obj)();
(0, _arrays.arraysHW)();
(0, _classes.classesHomeWork)();
},{"uikit":"node_modules/uikit/dist/js/uikit.js","./basics":"js/basics.js","./types":"js/types.js","./cycles":"js/cycles.js","./functions":"js/functions.js","./objects":"js/objects.js","./arrays":"js/arrays.js","./classes":"js/classes.js","uikit/dist/css/uikit.min.css":"node_modules/uikit/dist/css/uikit.min.css","../styles/style.scss":"styles/style.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
